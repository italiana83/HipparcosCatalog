...
namespace HipparcosCatalog
{
    ...
    public class Shader
    {
        ...
        public Shader(string vertexSource, string fragmentSource, string geometrySource = null, ShaderSourceMode mode = ShaderSourceMode.Code)
        {
            ...
            if (!string.IsNullOrEmpty(geometrySource))
            {
                geometryShader = CompileShader(ShaderType.GeometryShader, geometrySource);
            }
