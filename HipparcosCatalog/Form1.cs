...
namespace HipparcosCatalog
{
    public partial class Form1 : Form
    {
        ...
        BoundingBoxRenderer boundingBoxRenderer = new BoundingBoxRenderer();
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            boundingBoxRenderer.CreateBoundingBox(new Vector3(51, 75, 37), new Vector3(59, 93, 49));
        ...
        private void glControl1_Paint(object sender, PaintEventArgs e)
        {
            ...
            boundingBoxRenderer.DrawBoundingBox(view, _projection);
        ...
        private void glControl1_MouseWheel(object sender, MouseEventArgs e)
        {
            ...
            float scrollDelta = e.Delta; // Значение прокрутки
